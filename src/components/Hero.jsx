...
const Hero = () => {
    ...
    return (
        <div id='home' className='w-full px-[10%] md:px-[5%] xl:px-[16%] flex flex-col items-center pt-30 md:pb-42 md:pt-25 scroll-smooth' data-aos="fade-right">
            ...
            <div className='w-full z-10 desktop-aos' data-aos="fade-right">
